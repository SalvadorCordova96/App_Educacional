function ResourceLibrary() {
  // Mock de recursos descargables
  const recursos = [
    { nombre: 'Guía de Matemáticas', tipo: 'PDF', enlace: '#' },
    { nombre: 'Video: Historia Universal', tipo: 'Video', enlace: '#' },
    { nombre: 'Presentación STEAM', tipo: 'PPT', enlace: '#' },
  ];
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      <div className="w-full max-w-2xl p-8 bg-black shadow-2xl bg-opacity-80 rounded-xl">
        <h2 className="mb-6 text-3xl font-bold text-blue-400">Biblioteca de Recursos</h2>
