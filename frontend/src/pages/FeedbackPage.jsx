  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      <div className="w-full max-w-2xl p-8 bg-black shadow-2xl bg-opacity-70 rounded-xl">
        <h2 className="mb-6 text-3xl font-bold text-blue-400">Retroalimentación</h2>
        <p className="mb-4 text-white text-lg">Tu opinión es importante para mejorar la plataforma. Por favor, comparte tus comentarios o sugerencias.</p>
        <form className="flex flex-col gap-4 items-center">
          <textarea className="w-full rounded-lg p-4 bg-blue-950 bg-opacity-80 text-white focus:outline-none focus:ring-2 focus:ring-blue-400" rows={5} placeholder="Escribe tu retroalimentación aquí..." disabled />
