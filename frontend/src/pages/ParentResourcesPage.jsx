function ParentResourcesPage() {
  // Mock de recursos para padres para visualización
  const recursos = [
    { nombre: 'Guía para Padres', tipo: 'PDF', enlace: '#' },
    { nombre: 'Video: Apoyo en Casa', tipo: 'Video', enlace: '#' },
    { nombre: 'Consejos de Seguridad Digital', tipo: 'Artículo', enlace: '#' },
  ];
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      <div className="w-full max-w-2xl p-8 bg-black shadow-2xl bg-opacity-70 rounded-xl">
        <h2 className="mb-6 text-3xl font-bold text-blue-400">Recursos para Padres</h2>
